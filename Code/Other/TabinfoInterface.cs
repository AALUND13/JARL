...
namespace JARL
{
    ...
    {
        public static StatCategory armorsStatsCategory = null;
        ...
        public static void RegisterArmorTabinfoInterface(ArmorBase armor)
        {
            string armorType = armor.GetArmorType();
            TabInfoManager.RegisterStat(armorsStatsCategory, $"{armorType} Armor", (p) => p.data.GetAdditionalData().armorHandler.GetArmorByType(armorType).maxArmorValue > 0, (p) => {
